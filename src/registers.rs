...
impl DataLengthCode {
    ...
    pub const fn best_fit(data_length: usize) -> Option<Self> {
        match data_length {
            0 => Some(DataLengthCode::DLC_0),
            1 => Some(DataLengthCode::DLC_1),
            2 => Some(DataLengthCode::DLC_2),
            3 => Some(DataLengthCode::DLC_3),
            4 => Some(DataLengthCode::DLC_4),
            5 => Some(DataLengthCode::DLC_5),
            6 => Some(DataLengthCode::DLC_6),
            7 => Some(DataLengthCode::DLC_7),
            8 => Some(DataLengthCode::DLC_8),
            9..=12 => Some(DataLengthCode::DLC_12),
            13..=16 => Some(DataLengthCode::DLC_16),
            17..=20 => Some(DataLengthCode::DLC_20),
            21..=24 => Some(DataLengthCode::DLC_24),
            25..=32 => Some(DataLengthCode::DLC_32),
            33..=48 => Some(DataLengthCode::DLC_48),
            49..=64 => Some(DataLengthCode::DLC_64),
            _ => None,
        }
    }
}
